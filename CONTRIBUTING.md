...
First off, thank you for considering contributing to Errand! It's people like
you that make Errand such a great tool. 🎉
...
- [`good first issue`](https://github.com/MTG9T4/errand/labels/good%20first%20issue) -
  issues which should only require a few lines of code
- [`help wanted`](https://github.com/MTG9T4/errand/labels/help%20wanted) -
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/errand.git
cd errand

# Add upstream remote
git remote add upstream https://github.com/MTG9T4/errand.git
...
- Added to the
  [Contributors list](https://github.com/MTG9T4/errand/graphs/contributors)
...
Thank you for contributing to Errand! 🚀
