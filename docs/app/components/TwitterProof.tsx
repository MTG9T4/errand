...
const tweets = [
  {
    ...
    content:
      "Errand is a game changer for building AI agents! Finally a framework that makes sense.",
    date: "2h ago",
    likes: 42,
    verified: true,
  },
  {
    ...
    content:
      "Just shipped my first autonomous agent with Errand. The type-safety and modular architecture is *chef's kiss*",
    date: "5h ago",
    likes: 128,
    verified: false,
  },
  {
    ...
    content:
      "I built an autonomous trading agent in a weekend with Errand. The memory system is incredible.",
    date: "1d ago",
    likes: 87,
    verified: true,
  },
  {
    ...
    content:
      "Switching our entire agent infrastructure to Errand saved us months of development time. Highly recommend!",
    date: "2d ago",
    likes: 231,
    verified: true,
  },
  {
    ...
    content:
      "The context system in Errand is genius. Our agents now have perfect memory and state management.",
    date: "3d ago",
    likes: 64,
    verified: false,
  },
  {
    ...
    content:
      "After trying every agent framework out there, Errand is by far the most developer-friendly. The TypeScript integration is *perfect*.",
    date: "4d ago",
    likes: 157,
    verified: true,
  },
  {
    ...
    content:
      "Errand is doing for autonomous agents what React did for frontend. A true paradigm shift.",
    date: "5d ago",
    likes: 432,
    verified: true,
  },
  {
    ...
    content:
      "In a sea of agent frameworks, Errand stands out with its clean API, excellent docs, and thoughtful abstractions.",
    date: "6d ago",
    likes: 197,
    verified: false,
  },
  ...
  return (
    <div className="border-x border-t py-12 relative overflow-hidden">
      ...
      <p className="text-center text-white/70 mb-8 relative z-10 max-w-2xl mx-auto">
        Join the growing community of developers building with Errand
      </p>
