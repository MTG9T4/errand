...
function Terminal() {
  ...
  const handleCopyInstall = async () => {
    await navigator.clipboard.writeText("npm install @errand/core");
    setCopied(true);
      ...
      <div className="border border-border rounded-sm bg-card/50 backdrop-blur-sm p-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4 pt-4">
            ...
            <Link
              href="https://github.com/MTG9T4/errand"
              className="text-primary hover:underline text-sm"
            >
              [github]
            </Link>
      ...
      <div className="border border-border rounded-sm bg-background overflow-hidden">
        ...
        <pre className="p-4 text-xs overflow-x-auto">
          <code>
            ...
            {"\n"}
            <span className="text-primary">const</span> agent = createErrand(
            {"{\n"}
  ...
  return (
    <div className="mt-16 pt-8 border-t border-border">
      ...
      <div className="flex items-center justify-between pt-8 border-t border-border">
        <div className="text-xs text-muted-foreground">
          <span className="text-primary">errand@ai:~$</span> _
        </div>
