...
[@errand/core](./api-reference.md) / InferAgentContext

# Type Alias: InferAgentContext\<TAgent\>

> **InferAgentContext**\<`TAgent`\> = `TAgent` *extends* [`Agent`](./Agent.md)\<infer Content\> ? `Content` : `never`

Defined in: [packages/core/src/types.ts:48](https://github.com/dojoengine/errand/blob/612e9304717c546d301f9cac8c204de734cac957/packages/core/src/types.ts#L48)
