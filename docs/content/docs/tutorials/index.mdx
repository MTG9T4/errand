---
title: Tutorials
description: Hands-on examples and guides for building Errand agents.
---

## Getting Started

New to Errand? Start with the core tutorial that teaches contexts, composition, and action scoping:
