---
title: Installation
description: Set up Errand and configure your development environment.
---
...
- [ErrandRouter](https://router.errand.systems) -> `ERRANDROUTER_API_KEY`
...
There are two ways to get started with Errand:

<Tabs groupId="install-method" items={["Easy", "Manual"]} persist>

<Tab value="Easy">

The quickest way to get started is using the create-errand command:

<Steps>
<Step>
Run the create-errand command:

```bash title="create-errand.sh"
...
```bash title="create-errand-with-extensions.sh"
# With specific extensions
npx @errand/create-errand my-agent --twitter --discord --cli

# With all extensions
npx @errand/create-errand my-agent --all
```
...
pnpm init -y
pnpm add typescript tsx @types/node @errand/core @errand/cli
```
...
```bash title="package-install.sh"
npm init -y
npm install typescript tsx @types/node @errand/core @errand/cli
```
...
```bash title="package-install.sh"
bun init -y
bun add typescript tsx @types/node @errand/core @errand/cli
```
...
```bash title="package-install.sh"
yarn init -y
yarn add typescript tsx @types/node @errand/core @errand/cli
```
