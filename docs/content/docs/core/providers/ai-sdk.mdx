...
description: Leveraging the Vercel AI SDK with Errand.
---
...
Errand is built on top of the Vercel AI SDK, which means you get:
...
### ErrandRouter (100+ Models)

```typescript title="errand-setup.ts"
// Install: npm install @errand/ai-sdk-provider
import { errandrouter } from "@errand/ai-sdk-provider";

model: errandrouter("google/gemini-pro");
```
