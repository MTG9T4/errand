...
**Composable Contexts** - the key innovation that sets Errand apart.

Most AI frameworks treat conversations as stateless. Errand provides **isolated, stateful workspaces** that can be composed together for complex behaviors:
...
Errand agents are built from four core components:
