...
description:
  Build your first Errand agent and discover the power of contexts.
---

import { Tab, Tabs } from "fumadocs-ui/components/tabs";

## What Makes Errand Different?

Most AI frameworks treat conversations as stateless - every interaction starts
from scratch. But real conversations aren't like that. **Errand changes
...
With Errand contexts:

```text title="errand-stateful-approach.txt"
User: "I need help with my order"
Agent: "What's your order number?"
User: "12345"
...
An agent in Errand follows this cycle:
...
Let's build your first stateful agent! Start by installing Errand:

<Tabs groupId="language" items={["pnpm", "npm", "bun", "yarn"]} persist>
  <Tab value="pnpm">
    pnpm add @errand/core @errand/cli @ai-sdk/openai zod
  </Tab>
  <Tab value="npm">
    npm install @errand/core @errand/cli @ai-sdk/openai zod
  </Tab>
  <Tab value="bun">
    bun add @errand/core @errand/cli @ai-sdk/openai zod
  </Tab>
  <Tab value="yarn">
    yarn add @errand/core @errand/cli @ai-sdk/openai zod
  </Tab>
</Tabs>
...
1. **Context Creation** - When you started with user "alice", Errand created
...
Your customer service agent demonstrates the three key Errand concepts:
