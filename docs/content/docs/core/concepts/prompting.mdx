...
title: Prompting
description:
  How Errand structures prompts to guide LLM reasoning and actions.
---
...
### Agent Prompt (what Errand creates)
...
Errand automatically creates structured prompts that include:
...
## How Errand Builds Prompts

Every time your agent thinks, Errand automatically builds a prompt like this:
...
Errand uses a modular prompt system defined in `packages/core/src/prompts/main.ts`:
