...
description: How Errand agents process information and execute tasks.
---
...
The core of the Errand framework is the agent's execution lifecycle. This
...
This detailed cycle illustrates how Errand agents iteratively perceive (inputs, results), reason (LLM prompt/response), and act (outputs, actions), using streaming and asynchronous task management to handle complex interactions efficiently.
