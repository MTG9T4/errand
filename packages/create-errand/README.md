...
A CLI tool to bootstrap Errand agents easily.

## Usage

```bash
# Using npx (recommended)
npx @errand/create-errand my-agent

# Or install globally
npm install -g @errand/create-errand
...
```bash
npx @errand/create-errand my-agent --twitter --discord --cli
```
