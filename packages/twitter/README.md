# Enhanced Twitter Client for Errand AI
...
```typescript
import { EnhancedTwitterClient } from "@errand/twitter";
...
### Errand Extension Usage

```typescript
import { enhancedTwitter } from "@errand/twitter";
...
This package is part of the Errand AI ecosystem and follows the same license
terms.
