...
The episode export system provides a clean and extensible way to export conversation episodes from the Errand memory system.
...
```typescript
import { EpisodeExporter, ExportResult } from '@errand/core';
