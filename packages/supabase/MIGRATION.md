...
The Supabase package has been completely rewritten to support the new ErrandAI memory system. The new system provides:
...
4. **"Cannot find module '@errand/core'"**
   - Update `@errand/core` to the latest version

### Getting Help

1. Check the [README.md](./README.md) for complete API documentation
2. Look at examples in the ErrandAI repository
...
const agent = createErrand({ memory });
```
