# MCP Integration for Errand

This module provides integration with the Model Context Protocol (MCP), allowing
Errand agents to connect to any MCP server and access its resources, prompts,
and tools.
...
actual LLM interaction. This integration enables Errand agents to:
...
To connect your Errand agent to one or more MCP servers, add the MCP
